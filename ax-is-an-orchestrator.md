...
[The architecture guide](what-is-ax.md) expands the three resources and lifecycle. [Kubernetes is required for a real Task](kubernetes-required-for-tasks.md) explains where this infrastructure runs.
